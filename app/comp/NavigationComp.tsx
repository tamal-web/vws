...
export function NavLink({
  ...
  return (
    <NavigationMenuLink
      ...
      className={cn(
        path === pathName && "underline underline-offset-4",
        "text-[1.1rem]! hover:underline! underline-offset-4 bg-transparent! hover:text-black! active:text-black! focus:text-black! focus-visible:text-black! focus-within:text-black! ",
        navigationMenuTriggerStyle(),
        className
      )}
    >
